...
**Last updated:** 2026-05-02 — post v1.16.0 (Cross-Brand UX + Skoda
Charging Profiles: HA time platform für #26 + #25/#31 read-only via
charging-profiles endpoint + Cross-Brand OTA Probe Plan dokumentiert).
Nächste P0: v1.17.0 Skoda Vehicle-Info Bundle (vehicle-info + renders
+ equipment + widget endpoints) + Cross-Brand OTA Live-Test + Charging
Profile Write-Side.
