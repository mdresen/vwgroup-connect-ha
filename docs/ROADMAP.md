...
**Last updated:** 2026-05-04 — post v1.17.5 (Scout-Welle 5: 4
Community-Reports an einem Tag innerhalb 24h — #129 rocksandclouds,
#130 Chr1sDub, #132 rborkenhagen, #133 christianmhz + Gerhard's
parallele Cupra Born v1.17.4-Test-Reaktion auf #53. Total **42
neue Felder über 4 Brands** silenced via EXPECTED_KEYS Wildcards.
Plus Sprint-A Verification-Pings auf 4 ältere Issues #118 / #51
/ #48 / #42 + Diagnostic-Pings auf #131 Skoda Subscription +
#53 Gerhard Born Klima-Stop 404). Nächste P0: warten auf User-
Reaktionen (Gerhard mit Born-DEBUG-Log, Chr1sDub mit Subscription-
Bestätigung) ODER v1.18.0 Big-Bundle starten (Push FCM/MQTT,
Lovelace-Card Repo, ODER outside_temperature_c + workshop sensors).
