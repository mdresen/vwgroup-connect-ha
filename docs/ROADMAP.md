...
**Last updated:** 2026-05-03 — post v1.17.3 (Bruno-CI Stufe 2:
seat_cupra 35 .bru files at 100% strict mode + 7 skoda + 10
cariad_bff .bru files, plus 3 research docs (mitch-dc migration,
browser_mod integration, community VAG-HA landscape) + Lovelace
Cards README section + Tim outreach reply). Nächste P0: v1.17.4
Skoda + CARIAD-BFF Bruno coverage abschließen ODER v1.18.0 Push
Bundle (FCM für CUPRA/SEAT + MQTT für Skoda) ODER eigenes Lovelace-
Card Repo.
