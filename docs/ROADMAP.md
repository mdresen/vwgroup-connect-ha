...
**Last updated:** 2026-05-02 — post v1.17.1 (Bruno Quick-Wins Bundle:
window heating fix + ventilation + aux heating + battery care + #36
Navigation closer + 2× A/B-fallbacks + Cariad-Charging-Host research).
Nächste P0: v1.18.0 Push Bundle (FCM für CUPRA/SEAT + MQTT für Skoda)
ODER v1.17.2 Bruno-CI/Skill (Stufe 1 Bruno-CLI in CI für API-drift
detection).
