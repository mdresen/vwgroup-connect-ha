...
**Last updated:** 2026-05-03 — post v1.17.2 (Stale-cleanup of 17
references to 2 post-v1.17.0 removed research-docs + Bruno-CI Stufe 1
foundation: tests/bruno/ scaffold + GH Actions workflow +
scripts/check_bruno_url_drift.py + docs/BRUNO-WORKFLOW.md). Nächste
P0: v1.17.3 Bruno-CI Stufe 2 (full coverage + drift --strict gating)
ODER v1.18.0 Push Bundle (FCM CUPRA/SEAT + MQTT Skoda).
